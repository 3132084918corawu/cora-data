...
**GitHub Repository:** [https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map)

**OneDrive Large Files:** [Emotion City Map public OneDrive folder](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK)

**Public Access Links (replace placeholders after upload):**

- [GitHub repository root](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map)
- [Workflow source code folder](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/tree/main/workflow)
- [Dataset 1: Pinterest park images - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/photos1)
- [Dataset 2: Pinterest commercial images - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/photos2)
- [Dataset 3: Google Maps review outputs - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/dataset3_google_maps_reviews)
- [Dataset 4: OpenStreetMap POI CSV - GitHub](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/01_data_collection/dataset4_openstreetmap_poi/outputs/openstreetmap_poi_dataset.csv)
- [Design tool files: Cinema 4D + Processing - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/design_tool_integration)
- [Animation output: 65-second preview MP4 - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/emotion_city_preview_65s.mp4)
...
Notebook: [Cinema 4D animation script](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/05_design_tool_integration/cinema4d/generate_emotion_city_c4d.py) [Fragment rules CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/05_design_tool_integration/fragment_parameters/emotion_city_fragments_32.csv) [Processing emotion city sketch](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/python_processing/python_processing.pde) [Cinema 4D generator script](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/05_design_tool_integration/cinema4d/generate_emotion_city_c4d.py) [Fragment parameter generator pipeline](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/scripts/run_emotion_city_pipeline.py) [Design integration README](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/05_design_tool_integration/README.md) [Visualisation pipeline](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/scripts/run_emotion_city_pipeline.py) [Machine learning pipeline](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/scripts/run_emotion_city_pipeline.py) [OpenAI API synthetic text script](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/01_data_collection/dataset5_api_synthetic_emotion_text/scripts/generate_emotion_text_api.py) [Image vectorisation pipeline](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/scripts/run_emotion_city_pipeline.py) [Text vectorisation pipeline](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/scripts/run_emotion_city_pipeline.py) [Google Maps reviews collector](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/01_data_collection/dataset3_google_maps_reviews/scripts/collect_google_maps_reviews.py) [OpenStreetMap POI collector](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/01_data_collection/dataset4_openstreetmap_poi/scripts/collect_openstreetmap_poi.py) [Pinterest commercial scraping notebook](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/python%20final.ipynb) [Pinterest park scraping notebook](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/python%20final.ipynb)

Outputs: [65-second preview MP4 - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/emotion_city_preview_65s.mp4) / [Preview render script](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/06_report_assets/render_emotion_city_preview.py) [32 fragment parameter CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/05_design_tool_integration/fragment_parameters/emotion_city_fragments_32.csv) / [Fragment preview figure](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/04_visualisation/outputs/08_fragment_parameter_variation.png) [Processing sketch folder](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/tree/main/python_processing) / [Processing animation files - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/processing) [Cinema 4D Python script](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/05_design_tool_integration/cinema4d/generate_emotion_city_c4d.py) / [C4D scene and renders - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/cinema4d) [Fragment parameters CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/05_design_tool_integration/fragment_parameters/emotion_city_fragments_32.csv) [Design integration folder](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/tree/main/workflow/05_design_tool_integration) / [OneDrive large files folder](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/design_tool_integration) [Matplotlib/Seaborn figure folder](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/tree/main/workflow/04_visualisation/outputs) / [Report assets folder](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/tree/main/workflow/06_report_assets) [KMeans vs GMM cluster CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/03_machine_learning/outputs/osm_ml_clusters_kmeans_vs_gmm.csv) / [Metrics JSON](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/03_machine_learning/outputs/ml_metrics.json) [API synthetic emotion text folder](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/dataset5_api_synthetic_emotion_text) [Image colour/texture CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/outputs/image_vectorisation_colour_texture.csv) / [Image PCA figure](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/04_visualisation/outputs/04_image_colour_texture_pca.png) [TF-IDF vs Hashing CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/outputs/text_vectorisation_tfidf_vs_hashing.csv) / [Top terms CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/02_vectorisation/outputs/tfidf_svd_top_terms.csv) [Google reviews dataset output folder](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/dataset3_google_maps_reviews) / [Validator script](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/01_data_collection/dataset3_google_maps_reviews/scripts/validate_google_maps_reviews.py) [OSM POI dataset CSV](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/workflow/01_data_collection/dataset4_openstreetmap_poi/outputs/openstreetmap_poi_dataset.csv) / [Raw OSM JSON folder](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/tree/main/workflow/01_data_collection/dataset4_openstreetmap_poi/outputs/raw) [Commercial image folder - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/photos2) / [Metadata CSV - GitHub](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/metadata/pinterest_business%20environment_metadata.csv) [Park image folder - OneDrive](https://YOUR_ONEDRIVE_PUBLIC_FOLDER_LINK/photos1) / [Metadata CSV - GitHub](https://github.com/YOUR_GITHUB_USERNAME/emotion-city-map/blob/main/metadata/pinterest_future_city_metadata.csv)
